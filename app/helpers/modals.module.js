/**
 * Modified Version of https://github.com/dwmkerr/angular-modal-service
 */
...
([
    ...
    /***/ function (module, exports) {
        ...
        (function () {
            ...
            var module = angular.module('Modals', []);
            ...
            module.factory('ModalService', ['$animate', '$document', '$compile', '$controller', '$http', '$rootScope', '$q', '$templateRequest', '$timeout', function ($animate, $document, $compile, $controller, $http, $rootScope, $q, $templateRequest, $timeout) {
                ...
                function ModalService() {
                    ...
                    self.showErrorModal = function (message, title) {
                        self.showModal({
                            templateUrl: "/templates/dashboard/partials/error-modal.html",
                    ...
                    self.showModal = function (options) {
                        ...
                        //  Get the container of the document, we'll add the modal to this.
                        var container = angular.element(options.container || 'body');
                        ...
                        getTemplate(options.template, options.templateUrl).then(function (template) {
                            ...
                            //  Finally, add the modal to the dom.
                            if (options.replace) {
                                // Replace the container contents with the Modal!
                                container.html(modalElement);
                            } else {
                                // append to container when no custom append element is specified
                                appendChild(container, modalElement);
                            }
